...
setup(
    ...
    description="Wrapper around black to format stdin-passed doctest prompt code.",  # Optional
    ...
    entry_points={
        "console_scripts": ["docblacketeer=docblacketeer.cli:docblacketeer"]
    },  # Optional
